...
namespace CrazyDriver.Logic
{
    ...
    public sealed class TurretAim : RunPhaseBehaviour
    {
        ...
        [Inject]
        public void Construct(GameConstantsSO constants) => _settings = constants.Turret;
        ...
        /// pixel count, so sensitivity is identical on every density and aspect ratio.
        /// </summary>
        ...
        private void Update() =>
            _angle = Mathf.SmoothDamp(_angle, _targetAngle, ref _smoothingVelocity,
                _settings.SmoothingTime, Mathf.Infinity, Time.deltaTime);
    }
}
